...
export default function Hero() {
  return (
    <section className=" px-6 relative h-[960px] pt-26 pb-0 overflow-hidden bg-[#FCF7F1] -mx-[28px]">
      ...
      <div className=" pointer-events-none absolute bottom-0 left-1/2 -translate-x-1/2 w-full md:left-0 md:right-0 md:w-auto md:translate-x-0 flex justify-center">
